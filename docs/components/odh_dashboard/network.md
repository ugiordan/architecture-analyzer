...
graph LR
    ...
    np_0_odh_dashboard_allow_ports{{"odh-dashboard-allow-ports\nIngress"}}:::policy
    np_0_odh_dashboard_allow_ports --> odh_dashboard
    ...
    np_3_workspaces_controller{{"workspaces-controller\nIngress"}}:::policy
    np_3_workspaces_controller --> odh_dashboard
    np_4_allow_perses_operator_access{{"allow-perses-operator-access\nIngress"}}:::policy
    np_4_allow_perses_operator_access --> odh_dashboard
```
