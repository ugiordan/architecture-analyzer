...
|------|------|--------|-----------|-------|
| `internal/migration/detector.go:39` | 39 |  |  | get, list, watch, create, update, patch, delete |
| `internal/migration/detector.go:40` | 40 |  |  | get, list, watch |
| `internal/migration/detector.go:41` | 41 |  |  | get, list, watch, update, patch |
| `internal/migration/manual_strategy.go:33` | 33 |  |  | get, list, watch, update, patch |
| `internal/migration/svm_strategy.go:35` | 35 |  |  | get, list, watch, create, update, patch, delete |
