...
|------|------|--------|-----------|-------|
| `pkg/controller/v1alpha1/localmodel/distro/controller_rbac_ocp.go:23` | 23 |  |  |  |
| `pkg/controller/v1alpha1/localmodel/distro/controller_rbac_ocp.go:24` | 24 |  |  |  |
| `pkg/controller/v1alpha1/localmodelnode/distro/controller_rbac_ocp.go:23` | 23 |  |  |  |
| `pkg/controller/v1alpha2/llmisvc/controller.go:90` | 90 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:91` | 91 |  |  | get, update, patch |
| `pkg/controller/v1alpha2/llmisvc/controller.go:92` | 92 |  |  |  |
| `pkg/controller/v1alpha2/llmisvc/controller.go:93` | 93 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:94` | 94 |  |  |  |
| `pkg/controller/v1alpha2/llmisvc/controller.go:95` | 95 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:96` | 96 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:97` | 97 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:98` | 98 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:99` | 99 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:100` | 100 |  | httproutes, gateways, gatewayclasses | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:101` | 101 |  | inferencepools, inferenceobjectives, inferencemodels, inferencemodelrewrites, inferencepoolimports | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:102` | 102 |  | inferencepools, inferenceobjectives, inferencemodels | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:103` | 103 |  |  | get, list, watch |
| `pkg/controller/v1alpha2/llmisvc/controller.go:104` | 104 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:105` | 105 |  | roles, rolebindings, clusterrolebindings | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:106` | 106 |  |  | get, list, watch |
| `pkg/controller/v1alpha2/llmisvc/controller.go:107` | 107 |  | tokenreviews, subjectaccessreviews |  |
| `pkg/controller/v1alpha2/llmisvc/controller.go:108` | 108 |  |  |  |
| `pkg/controller/v1alpha2/llmisvc/controller.go:109` | 109 |  |  | create, patch, update |
| `pkg/controller/v1alpha2/llmisvc/controller.go:110` | 110 |  |  | get, list, watch |
| `pkg/controller/v1alpha2/llmisvc/controller.go:111` | 111 |  |  | get, list, watch |
| `pkg/controller/v1alpha2/llmisvc/controller.go:112` | 112 |  |  | update, patch |
| `pkg/controller/v1alpha2/llmisvc/controller.go:113` | 113 |  |  |  |
| `pkg/controller/v1alpha2/llmisvc/controller.go:114` | 114 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:115` | 115 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:116` | 116 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:117` | 117 |  |  | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/controller.go:118` | 118 |  | podmonitors, servicemonitors | get, list, watch, create, update, patch, delete |
| `pkg/controller/v1alpha2/llmisvc/distro/controller_rbac_ocp.go:23` | 23 |  |  | get, list, watch, create, update, delete |
| `pkg/controller/v1alpha2/llmisvc/distro/controller_rbac_ocp.go:24` | 24 |  |  |  |
