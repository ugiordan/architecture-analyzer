...
graph LR
    ...
    np_0_odh_dashboard_allow_ports --> opendatahub_operator
    np_1_kserve_controller_manager{{"kserve-controller-manager\nIngress"}}:::policy
    np_1_kserve_controller_manager --> opendatahub_operator
```
