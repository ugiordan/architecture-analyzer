...
| kserve | KernelCache |
| kserve | KernelCacheCapture |
| kserve | KernelCacheNode |
| kserve | KernelCacheNodeGroup |
...
| controller-manager-metrics-tls | feast | Opaque |
...
| kf-notebook-controller-metrics-tls | kubeflow | Opaque |
| odh-notebook-controller-metrics-tls | kubeflow | Opaque |
...
| seaweedfs-secret | model-registry | Opaque |
| skill-catalog-git-credentials | model-registry | Opaque |
| modelmesh-webhook-server-cert | modelmesh-serving | Opaque |
| maas-api-metrics-tls | models-as-a-service | Opaque |
| maas-api-serving-cert | models-as-a-service | kubernetes.io/tls |
| maas-controller-metrics-tls | models-as-a-service | Opaque |
| maas-controller-webhook-cert | models-as-a-service | kubernetes.io/tls |
| maas-discovery-tls | models-as-a-service | Opaque |
...
| data-connect-hub-proxy-tls | odh-dashboard | kubernetes.io/tls |
...
| maas-consumer-portal-tls | odh-dashboard | kubernetes.io/tls |
...
| notebooks-proxy-tls | odh-dashboard | kubernetes.io/tls |
| webhook-server-cert | odh-dashboard | Opaque |
| workspaces-controller-metrics-tls | odh-dashboard | kubernetes.io/tls |
| workspaces-controller-webhook-cert | odh-dashboard | Opaque |
...
| ogx-k8s-operator-controller-manager-metrics-service-tls | ogx-k8s-operator | Opaque |
...
| opendatahub-operator-metrics-tls | opendatahub-operator | Opaque |
...
| data-science-pipelines-operator | manager-role | 80 |
...
| odh-dashboard | maas-consumer-portal | 2 |
| odh-dashboard | odh-dashboard | 35 |
| odh-dashboard | odh-dashboard-agent-ops | 5 |
| odh-dashboard | odh-dashboard-automl | 2 |
| odh-dashboard | odh-dashboard-autorag | 2 |
| odh-dashboard | odh-dashboard-data-connect-hub-ui | 2 |
| odh-dashboard | odh-dashboard-data-registry-ui | 2 |
| odh-dashboard | odh-dashboard-eval-hub | 2 |
| odh-dashboard | odh-dashboard-gen-ai | 19 |
| odh-dashboard | odh-dashboard-maas | 4 |
| odh-dashboard | odh-dashboard-mlflow | 3 |
| odh-dashboard | odh-dashboard-model-registry | 2 |
| odh-dashboard | odh-dashboard-notebooks | 11 |
...
| odh-model-controller | odh-model-controller-role | 42 |
| odh-model-controller | proxy-role | 2 |
| ogx-k8s-operator | manager-role | 26 |
...
| trainer | trainer-metrics-reader | 0 |
| trainer | trainer-tls-profile | 2 |
...
|-------|---------|------|-------|
| llm-d | decode | ClusterIP | 8000/TCP, 6379/TCP |
...
| data-science-pipelines-operator | data-science-pipelines-operator-service | ClusterIP | 8443/TCP |
...
| odh-dashboard | maas-consumer-portal | ClusterIP | 8443/TCP |
...
| odh-dashboard | odh-dashboard-data-connect-hub-ui | ClusterIP | 9143/TCP |
| odh-dashboard | odh-dashboard-data-registry-ui | ClusterIP | 9143/TCP |
...
| odh-dashboard | odh-dashboard-notebooks-ui | ClusterIP | 9043/TCP |
| odh-dashboard | rhaii-dashboard | ClusterIP | 4000/TCP |
| odh-dashboard | workspaces-backend | ClusterIP | 4000/TCP |
| odh-dashboard | workspaces-controller-metrics-service | ClusterIP | 8443/TCP |
...
| odh-model-controller | odh-model-controller-metrics-service | ClusterIP | 8443/TCP |
