...
113 cluster roles across the platform.
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 60%; background: #e74c3c; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">56</span>
</div>
<div style="display: flex; align-items: center; gap: 8px;">
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 75%; background: #e74c3c; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 41%; background: #f39c12; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 50%; background: #f39c12; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 62%; background: #e74c3c; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
*55 bindings total. Showing the first 50.*
...
| data-science-pipelines-operator | 4 | manager-role | 56 | **wide** |
