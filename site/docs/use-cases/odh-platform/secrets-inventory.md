...
70 secrets referenced across the platform. No secret values are extracted, only names, types, and which component references them.
...
<div style="display: flex; align-items: center; gap: 8px;">
  <span style="min-width: 220px; text-align: right; font-size: 0.85em; white-space: nowrap;">agents-operator</span>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 11%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">2</span>
</div>
<div style="display: flex; align-items: center; gap: 8px;">
  <span style="min-width: 220px; text-align: right; font-size: 0.85em; white-space: nowrap;">feast</span>
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 5%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">1</span>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 16%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  <span style="min-width: 220px; text-align: right; font-size: 0.85em; white-space: nowrap;">kubeflow</span>
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 22%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  <span style="min-width: 220px; text-align: right; font-size: 0.85em; white-space: nowrap;">llm-d</span>
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 5%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">1</span>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 27%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">5</span>
</div>
<div style="display: flex; align-items: center; gap: 8px;">
...
<div style="display: flex; align-items: center; gap: 8px;">
  <span style="min-width: 220px; text-align: right; font-size: 0.85em; white-space: nowrap;">models-as-a-service</span>
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 27%; background: #27ae60; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">5</span>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 100%; background: #f39c12; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
| mlflow-operator | 0 | 1 | 1 |
| model-registry | 0 | 5 | 5 |
| model-registry-operator | 0 | 4 | 4 |
| modelmesh-serving | 0 | 1 | 1 |
| models-as-a-service | 2 | 3 | 5 |
| odh-dashboard | 14 | 4 | 18 |
| odh-model-controller | 2 | 0 | 2 |
| ogx-k8s-operator | 0 | 2 | 2 |
| opendatahub-operator | 2 | 2 | 4 |
| spark-operator | 0 | 1 | 1 |
| trainer | 0 | 1 | 1 |
| training-operator | 0 | 2 | 2 |
| trustyai-service-operator | 1 | 0 | 1 |
...
| Secret | Type |
|--------|------|
| kf-notebook-controller-metrics-tls | Opaque |
| odh-notebook-controller-metrics-tls | Opaque |
...
### mlflow-operator (1 secrets)

| Secret | Type |
|--------|------|
| controller-manager-metrics-tls | Opaque |

### model-registry (5 secrets)
...
| seaweedfs-secret | Opaque |
| skill-catalog-git-credentials | Opaque |

### model-registry-operator (4 secrets)
...
### opendatahub-operator (4 secrets)
...
### trustyai-service-operator (1 secrets)
...
- **Webhook certs** are the dominant secret type (32 of 70 secrets).
- **kubernetes.io/tls** secrets (22) are used for TLS-terminated services.
