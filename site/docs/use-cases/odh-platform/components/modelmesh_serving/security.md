...
| template-value-template-value | mm | ? | ? | ? | [`config/internal/base/deployment.yaml.tmpl`](https://github.com/kserve/modelmesh-serving/blob/1fcf541d867ceb459fbc76aa1e2bef102c4816db/config/internal/base/deployment.yaml.tmpl) |
| template-value-template-value | oauth-proxy | ? | ? | ? | [`config/internal/base/deployment.yaml.tmpl`](https://github.com/kserve/modelmesh-serving/blob/1fcf541d867ceb459fbc76aa1e2bef102c4816db/config/internal/base/deployment.yaml.tmpl) |
