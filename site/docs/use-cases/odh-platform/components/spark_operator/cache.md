...
| Type | Source | Risk |
|------|--------|------|
| corev1.Pod | `internal/controller/sparkapplication/controller.go:1355` | **HIGH** |
| networkingv1.Ingress | `internal/controller/sparkapplication/controller.go:1370` | medium |

### Issues

- Implicit informer for corev1.Pod via client.Get at internal/controller/sparkapplication/controller.go:1355 (cluster-wide, OOM risk). This bypasses cache filters and creates a full cluster-wide watch
