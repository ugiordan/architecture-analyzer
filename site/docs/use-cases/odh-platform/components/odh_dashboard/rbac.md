...
This component defines a large RBAC surface (301 diagram lines). The graph below groups roles by permission scope.
...
graph LR
    ...
    maas_consumer_portal["maas-consumer-portal\n2 resources"]:::narrow
    ...
    odh_dashboard_data_connect_hub_ui["odh-dashboard-data-connect-hub-ui\n2 resources"]:::narrow
    ...
    subj_maas_consumer_portal["maas-consumer-portal\nServiceAccount"]:::subject
    subj_maas_consumer_portal -->|binds| maas_consumer_portal
    ...
    subj_odh_dashboard_data_connect_hub_ui["odh-dashboard-data-connect-hub-ui\nServiceAccount"]:::subject
    subj_odh_dashboard_data_connect_hub_ui -->|binds| odh_dashboard_data_connect_hub_ui
...
|---------|------|------|---------|
| maas-consumer-portal | ClusterRoleBinding | maas-consumer-portal | ServiceAccount/maas-consumer-portal |
...
| odh-dashboard-data-connect-hub-ui | ClusterRoleBinding | odh-dashboard-data-connect-hub-ui | ServiceAccount/odh-dashboard-data-connect-hub-ui |
...
|------|------|------------|-----------|-------|
| maas-consumer-portal | ClusterRole |  | datascienceclusters | get, list |
| maas-consumer-portal | ClusterRole |  | ingresses | get |
...
| odh-dashboard | ClusterRole |  | apiservers | get |
...
| odh-dashboard-agent-ops | ClusterRole |  | apiservers | get |
| odh-dashboard-agent-ops | ClusterRole |  | subjectaccessreviews | create |
| odh-dashboard-automl | ClusterRole |  | apiservers | get |
| odh-dashboard-automl | ClusterRole |  | subjectaccessreviews | create |
| odh-dashboard-autorag | ClusterRole |  | apiservers | get |
| odh-dashboard-autorag | ClusterRole |  | subjectaccessreviews | create |
| odh-dashboard-data-connect-hub-ui | ClusterRole |  | configmaps | get, list, watch |
| odh-dashboard-data-connect-hub-ui | ClusterRole |  | subjectaccessreviews | create |
| odh-dashboard-data-registry-ui | ClusterRole |  | configmaps | get, list, watch |
| odh-dashboard-data-registry-ui | ClusterRole |  | apiservers | get |
| odh-dashboard-eval-hub | ClusterRole |  | apiservers | get |
...
| odh-dashboard-gen-ai | ClusterRole |  | apiservers | get |
| odh-dashboard-gen-ai | ClusterRole |  | secrets | get |
...
| odh-dashboard-notebooks | ClusterRole |  | tokenreviews | create |
