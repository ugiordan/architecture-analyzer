...
**Extracted:** 2026-09-19T04:06:08Z
...
graph LR
    ...
    controller -->|"Owns"| owned_11["Job"]
    class owned_11 owned
    controller -->|"Owns"| owned_12["NetworkPolicy"]
    class owned_12 owned
    controller -->|"Owns"| owned_13["PersistentVolumeClaim"]
    class owned_13 owned
    controller -->|"Owns"| owned_14["PodDisruptionBudget"]
    class owned_14 owned
    controller -->|"Owns"| owned_15["Role"]
    class owned_15 owned
    controller -->|"Owns"| owned_16["RoleBinding"]
    ...
    controller -->|"Owns"| owned_19["ValidatingWebhookConfiguration"]
    class owned_19 owned
    controller -.->|"depends on"| odh_20["odh-platform-utilities"]
    class odh_20 dep
```
...
|-------|---------|------|-------|--------|------------------|-----------|--------|
| llamastack.io | v1alpha1 | LlamaStackDistribution | Namespaced | 372 | 1 | YAML | [`config/crd/bases/llamastack.io_llamastackdistributions.yaml`](https://github.com/ogx-ai/ogx-k8s-operator/blob/d566a8f2cd76fcdaa4fd8e277a918525792ac223/config/crd/bases/llamastack.io_llamastackdistributions.yaml) |
| ogx.io | v1beta1 | OGXServer | Namespaced | 966 | 128 | YAML | [`config/crd/bases/ogx.io_ogxservers.yaml`](https://github.com/ogx-ai/ogx-k8s-operator/blob/d566a8f2cd76fcdaa4fd8e277a918525792ac223/config/crd/bases/ogx.io_ogxservers.yaml) |
