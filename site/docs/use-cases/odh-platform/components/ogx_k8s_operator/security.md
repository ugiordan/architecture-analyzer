...
|------------|-----------|--------------|------------|------------|--------|
| ogx-k8s-operator-controller-manager | manager | ? | ? | ? | [`kustomize:config/overlays/odh`](https://github.com/ogx-ai/ogx-k8s-operator/blob/d566a8f2cd76fcdaa4fd8e277a918525792ac223/kustomize:config/overlays/odh) |
| operator | manager | ? | true | ? | [`ogx-module/config/manager/manager.yaml`](https://github.com/ogx-ai/ogx-k8s-operator/blob/d566a8f2cd76fcdaa4fd8e277a918525792ac223/ogx-module/config/manager/manager.yaml) |
