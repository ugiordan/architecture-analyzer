...
|------------|-----------|--------------|------------|------------|--------|
| ogx-k8s-operator-controller-manager | manager | ? | true | ? | [`kustomize:config/overlays/odh`](https://github.com/ogx-ai/ogx-k8s-operator/blob/27242c097cb3c393e1e76645c8ff0dea75d24615/kustomize:config/overlays/odh) |
| operator | manager | ? | true | ? | [`ogx-module/config/manager/manager.yaml`](https://github.com/ogx-ai/ogx-k8s-operator/blob/27242c097cb3c393e1e76645c8ff0dea75d24615/ogx-module/config/manager/manager.yaml) |
