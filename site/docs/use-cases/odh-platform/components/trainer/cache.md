...
| Type | Source | Risk |
|------|--------|------|
| corev1.Secret | `pkg/runtime/framework/plugins/mpi/mpi.go:266` | **HIGH** |

### Issues

- Implicit informer for corev1.Secret via client.Get at pkg/runtime/framework/plugins/mpi/mpi.go:266 (cluster-wide, OOM risk). This bypasses cache filters and creates a full cluster-wide watch
