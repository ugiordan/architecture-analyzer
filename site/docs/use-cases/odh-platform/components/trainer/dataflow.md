...
| Method | Path | Source |
|--------|------|--------|
| * | / | [`pkg/statusserver/server.go:88`](https://github.com/kubeflow/trainer/blob/54cf912f6178514419d0db88dce322972e8234ac/pkg/statusserver/server.go#L88) |
| * | POST  | [`pkg/statusserver/server.go:87`](https://github.com/kubeflow/trainer/blob/54cf912f6178514419d0db88dce322972e8234ac/pkg/statusserver/server.go#L87) |
