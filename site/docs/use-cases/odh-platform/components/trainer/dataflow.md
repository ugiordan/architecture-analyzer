...
| Method | Path | Source |
|--------|------|--------|
| * | / | [`pkg/statusserver/server.go:88`](https://github.com/kubeflow/trainer/blob/ddebc07ad672db46320750b6bca2f95880668944/pkg/statusserver/server.go#L88) |
| * | POST  | [`pkg/statusserver/server.go:87`](https://github.com/kubeflow/trainer/blob/ddebc07ad672db46320750b6bca2f95880668944/pkg/statusserver/server.go#L87) |
