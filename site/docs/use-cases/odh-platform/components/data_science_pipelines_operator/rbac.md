...
This component defines a large RBAC surface (195 diagram lines). The graph below groups roles by permission scope.
...
| manager-role | ClusterRole |  | workflowartifactgctasks, workflowartifactgctasks/finalizers, workflows | create, delete, get, list, patch, update, watch |
