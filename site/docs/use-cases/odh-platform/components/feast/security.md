...
|------------|-----------|--------------|------------|------------|--------|
| controller-manager | manager | ? | ? | ? | [`infra/feast-operator/config/default/manager_config_patch.yaml`](https://github.com/feast-dev/feast/blob/ff274a6b65df387ef53ffc14b09fad6f07ac27fc/infra/feast-operator/config/default/manager_config_patch.yaml) |
| controller-manager | manager | ? | ? | ? | [`infra/feast-operator/config/manager/manager.yaml`](https://github.com/feast-dev/feast/blob/ff274a6b65df387ef53ffc14b09fad6f07ac27fc/infra/feast-operator/config/manager/manager.yaml) |
| controller-manager | manager | ? | true | ? | [`infra/feast-operator/config/overlays/rhoai/manager_patch.yaml`](https://github.com/feast-dev/feast/blob/ff274a6b65df387ef53ffc14b09fad6f07ac27fc/infra/feast-operator/config/overlays/rhoai/manager_patch.yaml) |
