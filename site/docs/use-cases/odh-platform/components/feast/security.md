...
|------------|-----------|--------------|------------|------------|--------|
| controller-manager | manager | ? | ? | ? | [`infra/feast-operator/config/default/manager_config_patch.yaml`](https://github.com/feast-dev/feast/blob/94a9b9a5b55ccdb2276943793c4b12e2caccfd3b/infra/feast-operator/config/default/manager_config_patch.yaml) |
| controller-manager | manager | ? | ? | ? | [`infra/feast-operator/config/manager/manager.yaml`](https://github.com/feast-dev/feast/blob/94a9b9a5b55ccdb2276943793c4b12e2caccfd3b/infra/feast-operator/config/manager/manager.yaml) |
| controller-manager | manager | ? | true | ? | [`infra/feast-operator/config/overlays/rhoai/manager_patch.yaml`](https://github.com/feast-dev/feast/blob/94a9b9a5b55ccdb2276943793c4b12e2caccfd3b/infra/feast-operator/config/overlays/rhoai/manager_patch.yaml) |
