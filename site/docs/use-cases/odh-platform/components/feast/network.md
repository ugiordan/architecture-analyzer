...
|------|------|-------|--------|
| uvicorn-server | python-source | 6566/TCP | [`infra/scripts/feature_server_docker_smoke.py:45`](https://github.com/feast-dev/feast/blob/ff274a6b65df387ef53ffc14b09fad6f07ac27fc/infra/scripts/feature_server_docker_smoke.py#L45) |
