...
|------|------|-------|--------|
| uvicorn-server | python-source | 6566/TCP | [`infra/scripts/feature_server_docker_smoke.py:45`](https://github.com/feast-dev/feast/blob/94a9b9a5b55ccdb2276943793c4b12e2caccfd3b/infra/scripts/feature_server_docker_smoke.py#L45) |
