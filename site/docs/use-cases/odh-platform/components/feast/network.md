...
|------|------|-------|--------|
| uvicorn-server | python-source | 6566/TCP | [`infra/scripts/feature_server_docker_smoke.py:45`](https://github.com/feast-dev/feast/blob/54f7db90bb5ccc4950d2a64bd859c050b066ffcb/infra/scripts/feature_server_docker_smoke.py#L45) |
