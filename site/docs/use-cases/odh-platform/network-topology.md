...
| data-science-pipelines-operator | 7 | 0 | 3 | 4 |
| feast | 1 | 0 | 0 | 1 |
| kserve | 6 | 3 | 3 | 0 |
...
| models-as-a-service | 4 | 1 | 1 | 2 |
| notebooks | 1 | 0 | 0 | 1 |
| odh-dashboard | 18 | 1 | 3 | 14 |
...
| Service | Type | Ports |
|---------|------|-------|
| data-science-pipelines-operator-service | ClusterIP | 8443/TCP |
...
| Service | Type | Ports |
|---------|------|-------|
| decode | ClusterIP | 8000/TCP, 6379/TCP |
...
### odh-dashboard (18 services)

| Service | Type | Ports |
|---------|------|-------|
| maas-consumer-portal | ClusterIP | 8443/TCP |
...
| odh-dashboard-data-connect-hub-ui | ClusterIP | 9143/TCP |
| odh-dashboard-data-registry-ui | ClusterIP | 9143/TCP |
...
| workspaces-controller-metrics-service | ClusterIP | 8443/TCP |
...
- **8000/TCP**: decode, render
- **8033/TCP**: model-mesh
- **8043/TCP**: odh-dashboard-model-registry-ui
- **8080/TCP**: mooncake-master-store, bundle-service, kuberay-operator, service, model-catalog, modelmesh-controller, maas-api, workspaces-frontend, model-serving-api, training-operator
- **8081/TCP**: cli-port-default
- **8143/TCP**: odh-dashboard-gen-ai-ui
- **8243/TCP**: odh-dashboard-maas-ui
- **8343/TCP**: odh-dashboard-mlflow-ui
- **8443/TCP**: data-science-pipelines-operator-service, ml-pipeline, template-value, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, mlflow-operator-controller-manager-metrics-service, model-registry-operator-controller-manager-metrics-service, maas-discovery, maas-consumer-portal, odh-dashboard, workspaces-controller-metrics-service, odh-model-controller-metrics-service, ogx-k8s-operator-controller-manager-metrics-service, trustyai-service-operator-controller-manager-metrics-service, trustyai-service-operator-metrics-service, controller-manager-metrics-service
...
- **9043/TCP**: odh-dashboard-notebooks-ui
- **9090/TCP**: ds-pipeline-workflow-controller-metrics-template-value, ${EPP_NAME}
- **9137/TCP**: env-port-default
- **9143/TCP**: odh-dashboard-data-connect-hub-ui, odh-dashboard-data-registry-ui
