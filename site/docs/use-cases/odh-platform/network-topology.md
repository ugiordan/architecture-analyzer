...
86 Kubernetes services across the platform.
...
- **8080/TCP**: mooncake-master-store, bundle-service, kuberay-operator, service, model-catalog, modelmesh-controller, maas-api, workspaces-controller-metrics-service, workspaces-frontend, model-serving-api, training-operator
- **8081/TCP**: cli-port-default
- **8143/TCP**: odh-dashboard-gen-ai-ui
- **8243/TCP**: odh-dashboard-maas-ui
- **8343/TCP**: odh-dashboard-mlflow-ui
- **8443/TCP**: data-science-pipelines-operator-service, ml-pipeline, template-value, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, mlflow-operator-controller-manager-metrics-service, model-registry-operator-controller-manager-metrics-service, maas-consumer-portal, odh-dashboard, odh-model-controller-metrics-service, ogx-k8s-operator-controller-manager-metrics-service, trustyai-service-operator-controller-manager-metrics-service, trustyai-service-operator-metrics-service, controller-manager-metrics-service
