...
| `Dockerfile.konflux.cpu` | registry.redhat.io/ubi9/ubi-minimal-pqc@sha256:8a842ac769de709143e4edeace516f2008dfdc431b64670ad3353fa323b44736 | 2 | 2000 |  |  |  |  |
...
| `docker/Dockerfile` | vllm-openai | 12 | vllm |  | multi-arch |  | Unpinned base image: ${BUILD_BASE_IMAGE}; Unpinned base image: base; Unpinned base image: base; Unpinned base image: base; Unpinned base image: base; Unpinned base image: base; Unpinned base image: ${FINAL_BASE_IMAGE}; Unpinned base image: vllm-base; Unpinned base image: vllm-base; Unpinned base image: vllm-openai-base; Unpinned base image: vllm-openai-base; Unpinned base image: vllm-openai |
| `docker/Dockerfile.cpu` | vllm-openai | 12 |  |  | multi-arch |  | Unpinned base image: base-common; Unpinned base image: base-common; Unpinned base image: base-${TARGETARCH}; Unpinned base image: base; Unpinned base image: base; Unpinned base image: base; Unpinned base image: vllm-build; Unpinned base image: vllm-test-deps; Unpinned base image: base; Unpinned base image: vllm-openai; No USER directive found (defaults to root) |
| `docker/Dockerfile.nightly_torch` | vllm-base | 5 |  |  | multi-arch |  | Unpinned base image: base; Unpinned base image: vllm-base; No USER directive found (defaults to root) |
...
| `docker/Dockerfile.rocm` | final | 18 |  |  |  |  | Unpinned base image: ${BASE_IMAGE}; Unpinned base image: base; Unpinned base image: base; Unpinned base image: fetch_vllm_${REMOTE_VLLM}; Unpinned base image: fetch_vllm; Unpinned base image: base; Unpinned base image: fetch_vllm; Unpinned base image: scratch; Unpinned base image: base; Unpinned base image: base; Unpinned base image: build_rocshmem; Unpinned base image: base; Unpinned base image: fetch_vllm; Unpinned base image: scratch; Unpinned base image: mori_base; Unpinned base image: ${CI_BASE_IMAGE}; Unpinned base image: mori_base; Unpinned base image: final; No USER directive found (defaults to root) |
...
| `docker/Dockerfile.s390x` | python-install | 12 | 2000 |  |  |  | Unpinned base image: base; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install; Unpinned base image: python-install |
| `docker/Dockerfile.tpu` | $BASE_IMAGE | 1 |  |  |  |  | Unpinned base image: $BASE_IMAGE; No USER directive found (defaults to root) |
| `docker/Dockerfile.xpu` | vllm-base | 4 |  |  |  |  | Unpinned base image: vllm-base; Unpinned base image: vllm-base; No USER directive found (defaults to root) |
