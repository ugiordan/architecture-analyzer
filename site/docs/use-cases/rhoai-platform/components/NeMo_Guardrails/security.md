...
| `Dockerfile.konflux` | ${BASE} | 8 | 1001 |  |  |  | Unpinned base image: ${MODELCAR_MINILM}; Unpinned base image: ${MODELCAR_SNOWFLAKE}; Unpinned base image: ${MODELCAR_SPACY}; Unpinned base image: ${MODELCAR_NLTK}; Unpinned base image: ${MODELCAR_DEBERTA}; Unpinned base image: ${MODELCAR_HAP}; Unpinned base image: ${BASE}; Unpinned base image: ${BASE} |
