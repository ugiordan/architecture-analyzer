...
| `Dockerfile.konflux` | ${UBI_MINIMAL_BASE_IMAGE} | 3 | orchestr8 |  |  |  | Unpinned base image: ${UBI_MINIMAL_BASE_IMAGE}; Unpinned base image: rust-builder; Unpinned base image: ${UBI_MINIMAL_BASE_IMAGE} |
