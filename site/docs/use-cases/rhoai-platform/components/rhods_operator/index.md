...
**Extracted:** 2026-09-26T04:27:29Z
...
```mermaid
graph LR
    %% Component architecture for rhods-operator
    ...
    subgraph controller["rhods-operator Controller"]
    ...
    controller -->|"Owns"| owned_34["Service"]
    class owned_34 owned
    controller -->|"Owns"| owned_35["ServiceAccount"]
    class owned_35 owned
    controller -->|"Owns"| owned_36["ValidatingWebhookConfiguration"]
    class owned_36 owned
    watch_37["Auth"] -->|"Watches"| controller
    class watch_37 external
    watch_38["ClusterRole"] -->|"Watches"| controller
    class watch_38 external
    watch_39["Namespace"] -->|"Watches"| controller
    class watch_39 external
    controller -.->|"depends on"| odh_40["models-as-a-service"]
    class odh_40 dep
    controller -.->|"depends on"| odh_41["odh-platform-utilities"]
    class odh_41 dep
    controller -.->|"depends on"| odh_42["odh-platform-utilities"]
    class odh_42 dep
    controller -.->|"depends on"| odh_43["opendatahub-operator"]
    class odh_43 dep
...
|-------|---------|------|-------|--------|------------------|-----------|--------|
| features.opendatahub.io | v1 | FeatureTracker | Cluster | 19 | 0 | Go AST | [`/home/runner/work/_temp/arch-analyzer-repos/rhods-operator/api/features/v1/features_types.go`](https://github.com/opendatahub-io/rhods-operator/blob/c797c263e2b046b249b9b6f501b5bec8bc6f8527//home/runner/work/_temp/arch-analyzer-repos/rhods-operator/api/features/v1/features_types.go) |
