...
**Extracted:** 2026-09-15T04:20:33Z
...
graph LR
    ...
    controller -->|"Owns"| owned_31["Secret"]
    ...
    controller -->|"Owns"| owned_34["StatefulSet"]
    class owned_34 owned
    controller -->|"Owns"| owned_35["VirtualService"]
    class owned_35 owned
    controller -.->|"depends on"| odh_36["mlflow-go"]
    class odh_36 dep
    controller -.->|"depends on"| odh_37["mlflow-go"]
    class odh_37 dep
    controller -.->|"depends on"| odh_38["odh-dashboard"]
    class odh_38 dep
    ...
    class odh_49 dep
    controller -.->|"depends on"| odh_50["odh-platform-utilities"]
    class odh_50 dep
    controller -.->|"depends on"| odh_51["ogx-k8s-operator"]
    class odh_51 dep
    controller -.->|"depends on"| odh_52["operator-chaos"]
    class odh_52 dep
```
