...
**Extracted:** 2026-09-19T04:09:57Z
...
|-------|---------|------|-------|--------|------------------|-----------|--------|
| inference.opendatahub.io | v1alpha1 | ExternalModel | Namespaced | 27 | 0 | YAML | [`config/crd/bases/inference.opendatahub.io_externalmodels.yaml`](https://github.com/opendatahub-io/ai-gateway-payload-processing/blob/4e3d67aea049be24517dfc44d54162998ecc26ef/config/crd/bases/inference.opendatahub.io_externalmodels.yaml) |
| inference.opendatahub.io | v1alpha1 | ExternalProvider | Namespaced | 20 | 0 | YAML | [`config/crd/bases/inference.opendatahub.io_externalproviders.yaml`](https://github.com/opendatahub-io/ai-gateway-payload-processing/blob/4e3d67aea049be24517dfc44d54162998ecc26ef/config/crd/bases/inference.opendatahub.io_externalproviders.yaml) |
