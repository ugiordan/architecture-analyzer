...
|------------|-----------|--------------|------------|------------|--------|
| model-serving-api | server | ? | true | ? | [`kustomize:config/overlays/odh`](https://github.com/opendatahub-io/odh-model-controller/blob/9012f99b1651067563582ebaf13843b11c90a0a0/kustomize:config/overlays/odh) |
| odh-model-controller | manager | ? | ? | ? | [`kustomize:config/overlays/odh`](https://github.com/opendatahub-io/odh-model-controller/blob/9012f99b1651067563582ebaf13843b11c90a0a0/kustomize:config/overlays/odh) |
