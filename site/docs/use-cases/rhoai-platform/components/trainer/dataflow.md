...
| Method | Path | Source |
|--------|------|--------|
| * | / | [`pkg/statusserver/server.go:88`](https://github.com/kubeflow/trainer/blob/b2400d1e5b8f3fe51cd0a3c2db8e6ff052a47215/pkg/statusserver/server.go#L88) |
| * | POST  | [`pkg/statusserver/server.go:87`](https://github.com/kubeflow/trainer/blob/b2400d1e5b8f3fe51cd0a3c2db8e6ff052a47215/pkg/statusserver/server.go#L87) |
