...
|------------|-----------|--------------|------------|------------|--------|
| kserve-controller-manager | manager | true | true | false | [`kustomize:config/overlays/odh`](https://github.com/kserve/kserve/blob/35c483ba3ffb20bd7e3175566e1eb7f749aaa33b/kustomize:config/overlays/odh) |
| kserve-localmodel-controller-manager | manager | true | true | false | [`config/localmodels/manager.yaml`](https://github.com/kserve/kserve/blob/35c483ba3ffb20bd7e3175566e1eb7f749aaa33b/config/localmodels/manager.yaml) |
| kserve-module-controller-manager | manager | true | true | false | [`kserve-module/config/manager.yaml`](https://github.com/kserve/kserve/blob/35c483ba3ffb20bd7e3175566e1eb7f749aaa33b/kserve-module/config/manager.yaml) |
| llmisvc-controller-manager | manager | true | true | false | [`kustomize:config/overlays/odh`](https://github.com/kserve/kserve/blob/35c483ba3ffb20bd7e3175566e1eb7f749aaa33b/kustomize:config/overlays/odh) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/default/manager_webhook_patch.yaml`](https://github.com/kserve/kserve/blob/35c483ba3ffb20bd7e3175566e1eb7f749aaa33b/kserve-module/prefetched-manifests-rhoai/modelcontroller/default/manager_webhook_patch.yaml) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/manager/manager.yaml`](https://github.com/kserve/kserve/blob/35c483ba3ffb20bd7e3175566e1eb7f749aaa33b/kserve-module/prefetched-manifests-rhoai/modelcontroller/manager/manager.yaml) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/overlays/xks/manager_xks_env_patch.yaml`](https://github.com/kserve/kserve/blob/35c483ba3ffb20bd7e3175566e1eb7f749aaa33b/kserve-module/prefetched-manifests-rhoai/modelcontroller/overlays/xks/manager_xks_env_patch.yaml) |
...
| `Dockerfiles/Dockerfile.konflux.kserve-module-controller` | registry.redhat.io/ubi9/ubi-minimal-pqc@sha256:a3f7ca6346ee5ca1867d1dcc79b011c5c711bf7a3e43c7cece3323d6d1ef5ac0 | 2 | 1000:1000 |  | multi-arch |  |  |
...
| `kernelcache/mcv/mcv.Dockerfile` | debian:bookworm-slim | 4 |  |  |  |  | Unpinned base image: deps; Unpinned base image: deps; No USER directive found (defaults to root) |
