...
|------------|-----------|--------------|------------|------------|--------|
| kserve-controller-manager | manager | true | true | false | [`kustomize:config/overlays/odh`](https://github.com/kserve/kserve/blob/0694c4ed702c0d31fdb6b2a54031a0fa7853898f/kustomize:config/overlays/odh) |
| kserve-localmodel-controller-manager | manager | true | true | false | [`config/localmodels/manager.yaml`](https://github.com/kserve/kserve/blob/0694c4ed702c0d31fdb6b2a54031a0fa7853898f/config/localmodels/manager.yaml) |
| kserve-module-controller-manager | manager | true | true | false | [`kserve-module/config/manager.yaml`](https://github.com/kserve/kserve/blob/0694c4ed702c0d31fdb6b2a54031a0fa7853898f/kserve-module/config/manager.yaml) |
| llmisvc-controller-manager | manager | true | true | false | [`kustomize:config/overlays/odh`](https://github.com/kserve/kserve/blob/0694c4ed702c0d31fdb6b2a54031a0fa7853898f/kustomize:config/overlays/odh) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/default/manager_webhook_patch.yaml`](https://github.com/kserve/kserve/blob/0694c4ed702c0d31fdb6b2a54031a0fa7853898f/kserve-module/prefetched-manifests-rhoai/modelcontroller/default/manager_webhook_patch.yaml) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/manager/manager.yaml`](https://github.com/kserve/kserve/blob/0694c4ed702c0d31fdb6b2a54031a0fa7853898f/kserve-module/prefetched-manifests-rhoai/modelcontroller/manager/manager.yaml) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/overlays/xks/manager_xks_env_patch.yaml`](https://github.com/kserve/kserve/blob/0694c4ed702c0d31fdb6b2a54031a0fa7853898f/kserve-module/prefetched-manifests-rhoai/modelcontroller/overlays/xks/manager_xks_env_patch.yaml) |
...
| `Dockerfiles/Dockerfile.konflux.kserve-module-controller` | registry.redhat.io/ubi9/ubi-minimal-pqc@sha256:fac0bde5012de6a8475bb5dc18db968cdc90b12d9dc2ffaddb4a4975d0b8a04f | 2 | 1000:1000 |  | multi-arch |  |  |
