...
|------------|-----------|--------------|------------|------------|--------|
| kserve-controller-manager | manager | true | true | false | [`kustomize:config/overlays/odh`](https://github.com/kserve/kserve/blob/aa529e4eb71dc9b7393b40467f4303024090ef34/kustomize:config/overlays/odh) |
| kserve-localmodel-controller-manager | manager | true | true | false | [`config/localmodels/manager.yaml`](https://github.com/kserve/kserve/blob/aa529e4eb71dc9b7393b40467f4303024090ef34/config/localmodels/manager.yaml) |
| kserve-module-controller-manager | manager | true | true | false | [`kserve-module/config/manager.yaml`](https://github.com/kserve/kserve/blob/aa529e4eb71dc9b7393b40467f4303024090ef34/kserve-module/config/manager.yaml) |
| llmisvc-controller-manager | manager | true | true | false | [`kustomize:config/overlays/odh`](https://github.com/kserve/kserve/blob/aa529e4eb71dc9b7393b40467f4303024090ef34/kustomize:config/overlays/odh) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/default/manager_webhook_patch.yaml`](https://github.com/kserve/kserve/blob/aa529e4eb71dc9b7393b40467f4303024090ef34/kserve-module/prefetched-manifests-rhoai/modelcontroller/default/manager_webhook_patch.yaml) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/manager/manager.yaml`](https://github.com/kserve/kserve/blob/aa529e4eb71dc9b7393b40467f4303024090ef34/kserve-module/prefetched-manifests-rhoai/modelcontroller/manager/manager.yaml) |
| odh-model-controller | manager | ? | ? | ? | [`kserve-module/prefetched-manifests-rhoai/modelcontroller/overlays/xks/manager_xks_env_patch.yaml`](https://github.com/kserve/kserve/blob/aa529e4eb71dc9b7393b40467f4303024090ef34/kserve-module/prefetched-manifests-rhoai/modelcontroller/overlays/xks/manager_xks_env_patch.yaml) |
...
| `Dockerfiles/Dockerfile.konflux.kserve-module-controller` | registry.redhat.io/ubi9/ubi-minimal-pqc@sha256:22c70d6d7fa920df140c5facdce1f42178642ca7613590da5466f69418ddf57a | 2 | 1000:1000 |  | multi-arch |  |  |
...
| `kernelcache/mcv/mcv.Dockerfile` | nvcr.io/nvidia/cuda:12.6.3-base-ubuntu24.04 | 8 | appuser |  | multi-arch |  | Unpinned base image: deps; Unpinned base image: deps; Unpinned base image: mcv-minimal |
