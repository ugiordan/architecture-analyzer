...
|------|------|---------------|
| webhook-server-cert | kubernetes.io/tls | deployment/controller-manager, deployment/trustyai-service-operator, service/webhook-service |
...
|------------|-----------|--------------|------------|------------|--------|
| trustyai-service-operator-controller-manager | manager | true | ? | ? | [`kustomize:config/overlays/odh`](https://github.com/trustyai-explainability/trustyai-service-operator/blob/254f286b10bc526904b2dd620fc2fa9af0b28bf8/kustomize:config/overlays/odh) |
...
| `trustyai-operator-module/Dockerfile.konflux` | registry.redhat.io/ubi9/ubi-minimal-pqc@sha256:8a842ac769de709143e4edeace516f2008dfdc431b64670ad3353fa323b44736 | 2 | 1000 |  | multi-arch |  |  |
