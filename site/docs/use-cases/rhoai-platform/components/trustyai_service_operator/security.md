...
|------------|-----------|--------------|------------|------------|--------|
| trustyai-service-operator-controller-manager | manager | true | ? | ? | [`kustomize:config/overlays/odh`](https://github.com/trustyai-explainability/trustyai-service-operator/blob/b4af0cbd650db3d1998280220593f3aae7be6616/kustomize:config/overlays/odh) |
