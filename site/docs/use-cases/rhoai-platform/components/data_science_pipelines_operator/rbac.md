...
This component defines a large RBAC surface (249 diagram lines). The graph below groups roles by permission scope.
...
graph LR
    ...
    prometheusrule_manager_role["prometheusrule-manager-role\n1 resources"]:::narrow
    end
    ...
    subj_controller_manager -->|binds| prometheusrule_manager_role
```
...
| prometheusrule-manager-rolebinding | RoleBinding | prometheusrule-manager-role | ServiceAccount/controller-manager |
...
| manager-role | ClusterRole |  | configmaps, persistentvolumeclaims, persistentvolumes, pods, pods/exec, pods/log, secrets, serviceaccounts, services | create, delete, get, list, patch, update, watch |
| manager-role | ClusterRole |  | events | create, list, patch |
| manager-role | ClusterRole |  | namespaces | get, list, watch |
| manager-role | ClusterRole |  | deployments, deployments/finalizers, replicasets | create, delete, get, list, patch, update, watch |
...
| manager-role | ClusterRole |  | customresourcedefinitions | get, list, patch, update, watch |
| manager-role | ClusterRole |  | customresourcedefinitions | list, watch |
| manager-role | ClusterRole |  | deployments | create, delete, get, list, patch, update, watch |
| manager-role | ClusterRole |  | clusterworkflowtemplates, clusterworkflowtemplates/finalizers, cronworkflows, cronworkflows/finalizers, workfloweventbindings, workfloweventbindings/finalizers, workflows, workflows/finalizers, workflowtaskresults, workflowtaskresults/finalizers, workflowtasksets, workflowtasksets/finalizers, workflowtemplates, workflowtemplates/finalizers | create, delete, deletecollection, get, list, patch, update, watch |
| manager-role | ClusterRole |  | workflowartifactgctasks, workflowartifactgctasks/finalizers | create, delete, get, list, patch, update, watch |
...
| manager-role | ClusterRole |  | aipipelines | get, list, patch, update, watch |
| manager-role | ClusterRole |  | aipipelines/finalizers | update |
| manager-role | ClusterRole |  | aipipelines/status | get, patch, update |
| manager-role | ClusterRole |  | datasciencepipelines | delete, get |
...
| manager-role | ClusterRole |  | scheduledworkflows, scheduledworkflows/finalizers | create, delete, get, list, patch, update, watch |
...
| manager-role | ClusterRole |  | prometheusrules | get, patch, update |
...
| manager-role | ClusterRole |  | clusterrolebindings, clusterroles, rolebindings, roles | delete, get, update |
...
| prometheusrule-manager-role | Role |  | prometheusrules | create |
