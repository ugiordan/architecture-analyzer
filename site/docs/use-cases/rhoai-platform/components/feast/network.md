...
|------|------|-------|--------|
| uvicorn-server | python-source | 6566/TCP | [`infra/scripts/feature_server_docker_smoke.py:45`](https://github.com/feast-dev/feast/blob/e4dcb8b09844322f5ab8a8c02c1e74fcc00d4985/infra/scripts/feature_server_docker_smoke.py#L45) |
