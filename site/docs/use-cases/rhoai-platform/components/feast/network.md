...
|------|------|-------|--------|
| uvicorn-server | python-source | 6566/TCP | [`infra/scripts/feature_server_docker_smoke.py:45`](https://github.com/feast-dev/feast/blob/b539a0ab200c3e5fc0152dce3f9da23706bdf1e2/infra/scripts/feature_server_docker_smoke.py#L45) |
