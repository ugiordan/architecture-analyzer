...
|------------|-----------|--------------|------------|------------|--------|
| bundle-service | bundle-service | ? | true | ? | [`kagenti-operator/config/bundleservice/deployment.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/cea595935e348e2f2c4bffc5481350fd8509d2d1/kagenti-operator/config/bundleservice/deployment.yaml) |
| controller-manager | manager | ? | ? | ? | [`kagenti-operator/config/default/manager_webhook_patch.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/cea595935e348e2f2c4bffc5481350fd8509d2d1/kagenti-operator/config/default/manager_webhook_patch.yaml) |
| controller-manager | manager | ? | ? | ? | [`kagenti-operator/config/manager/manager.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/cea595935e348e2f2c4bffc5481350fd8509d2d1/kagenti-operator/config/manager/manager.yaml) |
...
| `authbridge/cmd/authbridge-proxy/Dockerfile.konflux` | registry.redhat.io/ubi9/ubi-minimal@sha256:7fbeae18dc9476399f565e68255f602a3374ea8614ba3d14843565131a13ff93 | 2 | 1001 |  | multi-arch |  |  |
...
| `kagenti-operator/Dockerfile.konflux` | registry.redhat.io/ubi9/ubi-minimal@sha256:7fbeae18dc9476399f565e68255f602a3374ea8614ba3d14843565131a13ff93 | 2 | 65532:65532 |  | multi-arch |  |  |
