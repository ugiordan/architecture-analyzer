...
|------------|-----------|--------------|------------|------------|--------|
| bundle-service | bundle-service | ? | true | ? | [`kagenti-operator/config/bundleservice/deployment.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/9e220ac432288411fc12f4d92a47f2f665122ebb/kagenti-operator/config/bundleservice/deployment.yaml) |
| controller-manager | manager | ? | ? | ? | [`kagenti-operator/config/default/manager_webhook_patch.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/9e220ac432288411fc12f4d92a47f2f665122ebb/kagenti-operator/config/default/manager_webhook_patch.yaml) |
| controller-manager | manager | ? | ? | ? | [`kagenti-operator/config/manager/manager.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/9e220ac432288411fc12f4d92a47f2f665122ebb/kagenti-operator/config/manager/manager.yaml) |
...
| `authbridge/cmd/authbridge-proxy/Dockerfile.konflux` | registry.redhat.io/ubi9/ubi-minimal@sha256:8ebe2ad8fdf3cab3e5a53c1edc69194c98209cfadab24b884f4ad9ebcf7bbbfc | 2 | 1001 |  | multi-arch |  |  |
...
| `kagenti-operator/Dockerfile.konflux` | registry.redhat.io/ubi9/ubi-minimal@sha256:8ebe2ad8fdf3cab3e5a53c1edc69194c98209cfadab24b884f4ad9ebcf7bbbfc | 2 | 65532:65532 |  | multi-arch |  |  |
