...
|------------|-----------|--------------|------------|------------|--------|
| bundle-service | bundle-service | ? | true | ? | [`kagenti-operator/config/bundleservice/deployment.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/e64841a91b4b725b6ab587af6fa6dd945d6ef0d9/kagenti-operator/config/bundleservice/deployment.yaml) |
| controller-manager | manager | ? | ? | ? | [`kagenti-operator/config/default/manager_webhook_patch.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/e64841a91b4b725b6ab587af6fa6dd945d6ef0d9/kagenti-operator/config/default/manager_webhook_patch.yaml) |
| controller-manager | manager | ? | ? | ? | [`kagenti-operator/config/manager/manager.yaml`](https://github.com/red-hat-data-services/agents-operator/blob/e64841a91b4b725b6ab587af6fa6dd945d6ef0d9/kagenti-operator/config/manager/manager.yaml) |
...
| `authbridge/cmd/authbridge-proxy/Dockerfile.konflux` | registry.redhat.io/ubi9/ubi-minimal@sha256:186a94b76e386782f576c9c49813b16dceb2ba63102af5a28405dcefec2806d0 | 2 | 1001 |  | multi-arch |  |  |
...
| `kagenti-operator/Dockerfile.konflux` | registry.redhat.io/ubi9/ubi-minimal@sha256:186a94b76e386782f576c9c49813b16dceb2ba63102af5a28405dcefec2806d0 | 2 | 65532:65532 |  | multi-arch |  |  |
