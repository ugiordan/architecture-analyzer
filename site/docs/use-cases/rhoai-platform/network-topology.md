...
84 Kubernetes services across the platform.
...
- **8000/TCP**: decode, render, cli-port-default
- **8033/TCP**: inference-server
- **8043/TCP**: odh-dashboard-model-registry-ui
- **8080/TCP**: mooncake-master-store, bundle-service, model-serving-api, kuberay-operator, service, service, model-catalog, modelmesh-controller, maas-api, workspaces-frontend, model-serving-api, training-operator
- **8143/TCP**: odh-dashboard-gen-ai-ui
- **8243/TCP**: odh-dashboard-maas-ui
- **8343/TCP**: odh-dashboard-mlflow-ui
- **8443/TCP**: data-science-pipelines-operator-service, ml-pipeline, template-value, kserve-controller-manager-metrics-service, kserve-controller-manager-service, llmisvc-controller-manager-service, mlflow-operator-controller-manager-metrics-service, model-registry-operator-controller-manager-metrics-service, maas-consumer-portal, odh-dashboard, workspaces-controller-metrics-service, odh-model-controller-metrics-service, ogx-k8s-operator-controller-manager-metrics-service, trustyai-service-operator-controller-manager-metrics-service, trustyai-service-operator-metrics-service, controller-manager-metrics-service
