...
109 cluster roles across the platform.
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 57%; background: #e74c3c; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 22%; background: #f39c12; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <span style="min-width: 30px; font-size: 0.85em; font-weight: 600;">59</span>
</div>
<div style="display: flex; align-items: center; gap: 8px;">
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 47%; background: #f39c12; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 71%; background: #e74c3c; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 54%; background: #e74c3c; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
*51 bindings total. Showing the first 50.*
...
graph LR
    ...
    sa_controller_manager -->|rhods-operator| role_controller_manager_role
    ...
    sa_spark_operator_webhook["spark-operator-webhook\nServiceAccount"]:::subject
    sa_spark_operator_webhook -->|spark-operator| role_spark_operator_tls_profile
    ...
    role_kubeflow_trainer_view_cluster_runtimes["kubeflow-trainer-view-cluster-runtimes"]:::role
    sa_system_authenticated -->|trainer| role_kubeflow_trainer_view_cluster_runtimes
    role_trainer_tls_profile["trainer-tls-profile"]:::role
    sa_kubeflow_trainer_controller_manager -->|trainer| role_trainer_tls_profile
```
...
| data-science-pipelines-operator | 4 | manager-role | 59 | **wide** |
| kserve | 2 | kserve-manager-role | 43 | **wide** |
| mlflow-operator | 6 | manager-role | 21 | medium |
| model-registry | 6 | model-registry-manager-role | 3 | narrow |
| model-registry-operator | 6 | manager-role | 28 | medium |
| odh-dashboard | 11 | odh-dashboard | 34 | **wide** |
| odh-model-controller | 7 | odh-model-controller-role | 42 | **wide** |
| ogx-k8s-operator | 5 | manager-role | 23 | medium |
| rhods-operator | 19 | kueue-editor-role | 2 | narrow |
| spark-operator | 6 | spark-operator-controller | 16 | medium |
| trainer | 10 | kubeflow-trainer-controller-manager | 17 | medium |
