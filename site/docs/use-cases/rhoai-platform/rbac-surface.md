...
111 cluster roles across the platform.
...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 59%; background: #e74c3c; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
*53 bindings total. Showing the first 50.*
