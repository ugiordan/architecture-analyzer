...
<div style="display: flex; align-items: center; gap: 8px;">
  ...
  <div style="flex: 1; background: var(--md-default-fg-color--lightest); border-radius: 4px; height: 22px; position: relative;">
    <div style="width: 33%; background: #f39c12; height: 100%; border-radius: 4px; min-width: 20px;"></div>
  </div>
...
| ogx-k8s-operator | 5 | manager-role | 27 | medium |
| rhods-operator | 19 | kueue-editor-role | 2 | narrow |
| spark-operator | 6 | spark-operator-controller | 16 | medium |
| trainer | 10 | kubeflow-trainer-controller-manager | 19 | medium |
